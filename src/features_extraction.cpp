...
//    showElaborationStatusToTheUser("ContainmentWindow", nativeSuperPixelContainmentWindow);
        ...
        auto soi = phd::segmentation::extractPotholeRegionFromCandidate(nativeSuperPixelContainmentWindow, exclusionMask, thresholds);
        ...
        for (int i = 0; i < soi.size(); ++i) {
            ...
            Mat histogram = phd::features::histogram(candidateGrayScale, candidateSuperPixel.mask, 256);
